...
export function middleware(req: NextRequest) {
  ...
  if (protectedRoutes.some((route) => url.pathname.startsWith(route))) {
    ...
    if (
      url.pathname.startsWith("/dashboard/recruiter") &&
  ...
  if (
    req.nextUrl.pathname.startsWith("/dashboard/user/profile") &&
    decoded?.role !== "user"
  ) {
  ...
  if (
    req.nextUrl.pathname.startsWith("/dashboard/recruiter/profile") &&
    decoded?.role !== "recruiter"
  ) {
    return NextResponse.redirect(new URL("/", req.url));
  }
